    ...
    >
      ...
      <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {situations.map(({ title, description, Icon }) => (
          <article
            key={title}
            className="rounded-3xl border border-luma-hairline bg-white p-6 shadow-[0_10px_28px_rgba(61,47,30,0.04)] transition-transform duration-200 hover:-translate-y-1"
          >
